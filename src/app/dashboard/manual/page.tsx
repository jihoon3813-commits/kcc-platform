...
export default function PartnerManualPage() {
    ...
    const steps = [
        ...
        },
        {
            ...
            actions: [
                '1. [고객관리] 메뉴에서 해당 고객 리스트 클릭하여 상세창 연기',
        ...
        },
        {
            ...
            title: '전자 서명',
            actor: '고객',
            description: '계약 문자 수신 후 본인인증 및 온라인 서명',
            actions: [
        ...
        },
        {
            ...
            title: '녹취 약정 진행',
            actor: '고객',
            description: '상담원 해피콜 수신 및 유선 계약 확인',
            actions: [
                    ...
                    <div style={{ display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap' }}>
                        {['파트너', '고객', '구독센터'].map(actor => (
                            <span key={actor} style={{
                                padding: '0.4rem 1rem',
                                borderRadius: '2rem',
                                backgroundColor: getActorBg(actor),
                                ...
                                <span style={{ width: '8px', height: '8px', borderRadius: '50%', backgroundColor: getActorColor(actor) }}></span>
                                {actor} 수행
                            </span>
                        ))}
                    </div>
                                ...
                                <div key={item.step} style={{ position: 'relative', display: 'flex', gap: '2rem', zIndex: 1 }}>
                                    ...
                                    <div style={{
                                        ...
                                        <div style={{ backgroundColor: '#f8fafc', padding: '1rem', borderRadius: '0.75rem' }}>
                                            <ul style={{ margin: 0, paddingLeft: '0', listStyleType: 'none', display: 'flex', flexDirection: 'column', gap: '0.5rem', marginBottom: (item.step === '01' || item.step === '03') ? '1.5rem' : 0 }}>
                                            ...
                                            {(item.step === '01' || item.step === '03') && (
                                                <div style={{ marginTop: '1rem', border: '1px solid #e2e8f0', borderRadius: '0.5rem', overflow: 'hidden' }}>
                                                    <div style={{ padding: '0.5rem 1rem', background: '#f1f5f9', borderBottom: '1px solid #e2e8f0', fontSize: '0.75rem', fontWeight: 600, color: '#64748b' }}>
                                                        🖥️ 어드민 화면 예시
                                                    </div>
                                                    <img 
                                                        src={`/images/manual/step${item.step}.png`} 
